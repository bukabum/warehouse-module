        ...
        <div className="divControl">
            ...
            <Card>
                <CardContent>
                        ...
                        <Typography>
                            <p>Nama Pemesan: <Link style={{ textDecoration: 'none' }} to={"/Warehouse-Customer/customer/detail/" + order.customer.id}>{order.customer ? order.customer.nama_pelanggan : '' }</Link></p>
                    ...
                    <CardActions>
                        <Link to={"/Warehouse-Customer/order/invoice/" + props.match.params.itemPK} style={{ textDecoration: 'none' }}><Button>Invoice</Button></Link>
